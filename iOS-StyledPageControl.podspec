#
#  Be sure to run `pod spec lint iOS-StyledPageControl.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "Pavel Zubco" => "zubco.pavel@gmail.com" }
  # Or just: s.author    = "Pavel Zubco"
  # s.authors            = { "Pavel Zubco" => "zubco.pavel@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Pavel Zubco"
